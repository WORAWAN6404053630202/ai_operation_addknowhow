...
SYNONYM_PATTERNS: List[Tuple[str, str]] = [
    ...
    (r"\bvat\b|ภพ\.?20|ภาษีมูลค่าเพิ่ม",             "ภาษีมูลค่าเพิ่ม ภพ.20 จด VAT กรมสรรพากร"),
    ...
    (r"qr.?pay|qr.?payment|พร้อมเพย์|promptpay|คิวอาร์|คิวอาเพ|คิวอาพาย",
                                                        "ระบบชำระเงินออนไลน์ QR Payment พร้อมเพย์"),
